...
const QuestionnaireUpdateDialog =  ({ questionnaire : oldQuestionnaire, update }) => {
    ...
    return (
        <div>
          <Button color="primary" onClick={ open } className='float-right' >Edit</Button>
            ...
            <ModalBody>
               <Form>
                 <FormGroup row>
                   ...
                   <Col md={10}>
                     <Input type="text" name="title" value={ questionnaire.title } id="formTitle" onChange={ onChange } />
                   </Col>
                 </FormGroup>
                 ...
                 <FormGroup row>
                   ...
                   <Col md={10}>
                     <Input type="text" name="description" value={ questionnaire.description } id="formDescription" onChange={ onChange } />
                   </Col>
                 </FormGroup>
  
                 <FormGroup>
                   <Col className="clearfix" style={{ padding: '.2rem' }}>
                     <Button className="float-right" color="secondary" onClick={ onSubmit }>Save</Button>
                   </Col>
                 </FormGroup>
               </Form>
            </ModalBody>
